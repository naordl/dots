...
case "$choice" in
    y)
      ...
      cp -rv ~/.config/{alacritty,dunst,git,gtk-2.0,gtk-3.0,i3,tmux,neofetch,nvim,mpd,ncmpcpp,picom,paru,ranger,lf,sxhkd,sxiv,x11,zsh,zathura,user-dirs.dirs,wall.png} $DOTDIR/.config/
