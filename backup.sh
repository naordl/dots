...
case "$choice" in
	yes)
	  ...
	  cp -rv ~/.config/{alacritty,dunst,git,gtk-2.0,gtk-3.0,i3,tmux,networkmanager-dmenu,nvim,mpd,ncmpcpp,picom,paru,ranger,sxhkd,X11,zsh,bash,zathura,user-dirs.dirs,wall.png} $DOTDIR/.config/
