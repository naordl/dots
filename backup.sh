...
case "$choice" in
	yes)
	  ...
	  cp -rv ~/.config/{alacritty,bspwm,dunst,git,gtk-2.0,gtk-3.0,i3,tmux,networkmanager-dmenu,nvim,picom,polybar,paru,qutebrowser,ranger,sxhkd,vis,X11,zsh,bash,zathura,user-dirs.dirs,user-dirs.locale,wall.png} $DOTDIR/.config/
